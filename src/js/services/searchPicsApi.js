...
export default class SearchPicsService {
  ...
  async fetchPics() {
    ...
    try {
      const response = await axios.get(`/?key=${API_KEY}&q=${this.searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&page=${this.page}&per_page=${this.perPage}`);
